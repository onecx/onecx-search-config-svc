...
import gen.io.github.onecx.search.config.v1.model.GetSearchTemplatesResponseDTOV1;
import io.quarkus.test.junit.QuarkusTest;

@QuarkusTest
public class SearchConfigControllerV1Test extends AbstractTest {
    ...
    public void shouldGetSearchConfigsByPage() {
        ...
        GetSearchTemplatesResponseDTOV1 getSearchTemplatesResponseDTO = response.as(GetSearchTemplatesResponseDTOV1.class);
        // then
    ...
    public void shouldNotGetSearchTemplateByIdNotExists() {
        ...
        var response = given()
                .contentType(MediaType.APPLICATION_JSON)
                .when()
                .get(SEARCH_CONFIG_CONTROLLER_INTERNAL_ENDPOINT + "/" + templateId);
    ...
    public void shouldCreateSearchTemplate() {
        ...
        //            assertEquals(newSearchConfig.getApplication(), searchTemplateDTOv1.getApplication());
        //            assertEquals(newSearchConfig.getName(), searchTemplateDTOv1.getName());
        //            assertEquals(newSearchConfig.getUser(), searchTemplateDTOv1.getUser());
        //            assertEquals(newSearchConfig.getPage(), searchTemplateDTOv1.getPage());
        //            assertEquals(newSearchConfig.getCriteriaAsJson(), searchTemplateDTOv1.getCriteriaAsJson());
    }
    //
    //    @Test
